...
# 创建外星人
def create_alien(ai_settings, screen, aliens, ship):
        alien = Aline(ai_settings, screen)
        alien.rect.x = randint(0, ai_settings.screen_width)
        alien.rect.y = randint(0, ai_settings.screen_height - ship.rect.height)
        aliens.add(alien)


# 创建外星人群
def create_fleet(ai_settings, screen, ship, aliens):
    create_alien(ai_settings, screen, aliens, ship)
